import{_ as e,d as t,y as a}from"./v-preact-BAP1wjwx.js";import{h as r}from"./v-misc-CJ9EBB9u.js";import{t as d}from"./c-dash-gHEFlTep.js";import{_ as l}from"./v-ui-BuZZnogH.js";const i=r.bind(e),s="RESET";function n({isOpen:e,onClose:r,onConfirm:n}){const[o,g]=t(""),[p,b]=t(10),[c,m]=t(!1);a(()=>{e&&(g(""),b(10),m(!1))},[e]),a(()=>{if(!e||0===p)return;const t=setInterval(()=>{b(e=>Math.max(0,e-1))},1e3);return()=>clearInterval(t)},[e,p]);const u=o===s&&0===p&&!c;return i`
    <${l}
      open=${e}
      onClose=${()=>!c&&r()}
      class="relative z-50"
        ...
        <${l.Panel} class="mx-auto max-w-lg w-full bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 animate-fade-in">
          ...
          <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Type <span class="font-mono font-bold text-red-600 dark:text-red-400">${s}</span> to confirm:
            </label>
            <input
              type="text"
              value=${o}
              ...
              disabled=${c||p>0}
              placeholder=${p>0?"Waiting for countdown...":`Type "${s}"`}
              class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border-2 ${o===s?"border-red-500 dark:border-red-400":"border-gray-300 dark:border-gray-600"} rounded-lg text-gray-900 dark:text-white font-mono font-bold text-center text-lg focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            />
            ${o&&o!==s&&i`
              <p class="mt-2 text-sm text-red-600 dark:text-red-400">
                Text does not match. Please type exactly: ${s}
              </p>
            `}
            ${o===s&&0===p&&i`
          ...
          <div class="flex gap-3">
            ...
            <button
              onClick=${async()=>{if(u){m(!0);try{await n(),d.success("Factory reset completed successfully"),r()}catch(e){d.error(`Factory reset failed: ${e.message}`)}finally{m(!1)}}}}
              disabled=${!u}
  ...
  `}const o=r.bind(e);function g({label:e,value:r,onChange:d,validator:l,type:i="text",step:s,placeholder:n,required:g=!1,helpText:p}){const[b,c]=t(!1),[m,u]=t({isValid:!0,error:null});a(()=>{if(l&&""!==r&&null!=r){const e=l(r);u(e)}else g||""!==r&&null!=r||u({isValid:!0,error:null})},[r,l,g]);const y=b&&!m.isValid,x=b&&m.isValid&&""!==r&&null!==r;return o`
    <div class="mb-4">
      <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
        ${e}
    ...
    `}
          ...
          <div class="flex justify-between items-center pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex gap-3">
              ...
              ${l<w.length-1?x`
                    <button
                      onClick=${()=>{l<w.length-1&&i(l+1)}}
                      disabled=${!(()=>{switch(l){case 0:return(()=>{const e=m(o.ssid).isValid,t=o.password.length>=8;return e&&t})();case 1:return(()=>{const e=u(v.broker).isValid,t=y(v.port).isValid;return e&&t})();case 2:return(()=>{const e=c(h.kp,"kp").isValid,t=c(h.ki,"ki").isValid,a=c(h.kd,"kd").isValid;return e&&t&&a})();case 3:return!0;default:return!1}})()||s}
      ...
      ${"network"===p&&k`
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
          ...
          <div class="space-y-4">
            ...
            >
              ${s?"Saving...":"Save Network Settings"}
            </button>
          </div>
        </div>
      `}
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3">
              <button
                ...
                class="px-4 py-2 bg-primary-500 hover:bg-primary-600 disabled:bg-gray-400 text-white rounded-lg font-medium transition-all"
              >
                ${s?"Saving...":"Save Webhook Settings"}
              </button>
              <button
